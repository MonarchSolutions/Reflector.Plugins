...
namespace Reflector.Emit.CodeModel
{
    public class Visitor
    {
        ...
        public virtual void VisitStatement(IStatement value)
        {
            if (value != null)
            {
                if (value is IExpressionStatement statement)
                {
                ...
                else if (value is IUsingStatement usingStatement)
                {
                ...
                else
                {
                    ...
                    {
                        throw new NotSupportedException(string.Format(CultureInfo.InvariantCulture, "Invalid statement type '{0}'.", new object[]
                        {
                            value.GetType().Name
                        }));
                    }
                    VisitDebugBreakStatement((IDebugBreakStatement) value);
                }
            }
        }
        ...
        public virtual void VisitExpression(IExpression value)
        {
            if (value != null)
            {
                ...
                else if (value is IPropertyIndexerExpression indexerExpression)
                {
                    VisitPropertyIndexerExpression(indexerExpression);
                }
                else if (value is IArrayIndexerExpression arrayIndexerExpression)
                {
                ...
                else if (value is ITypeOfTypedReferenceExpression typedReferenceExpression)
                {
                    VisitTypeOfTypedReferenceExpression(typedReferenceExpression);
                }
                else if (value is IValueOfTypedReferenceExpression ofTypedReferenceExpression)
                {
                    VisitValueOfTypedReferenceExpression(ofTypedReferenceExpression);
                }
                ...
                else
                {
                    ...
                    {
                        throw new NotSupportedException(string.Format(CultureInfo.InvariantCulture, "Invalid expression type '{0}'.", new object[]
                        {
                            value.GetType().Name
                        }));
                    }
                    VisitSnippetExpression((ISnippetExpression) value);
                }
            }
        }
        ...
        public virtual void VisitQueryClause(IQueryClause value)
        {
            ...
            else
            {
                ...
                VisitOrderClause((IOrderClause) value);
            }
        }
        ...
        public virtual void VisitQueryOperation(IQueryOperation value)
        {
            ...
            else
            {
                ...
                VisitGroupOperation((IGroupOperation) value);
            }
        }
